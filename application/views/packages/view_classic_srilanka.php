        ...
        <div class="row blog-page">    
            ...
            <div class="col-sm-8">
                <div class="blog margin-bottom-30">
                    <h3>Classic Sri Lanka - 10 Days / 09 Nights</h3>
                    <div class="inline blog-info">
                        <p>This package consists of the Finest of the locations that Sri Lanka has to offer, ranging from Wildlife to Religious destinations the country. Sri Lanka is home to roughly 123 species of mammals. Of these species, Asian elephants, sloth bear, leopards, and  wild buffaloes engages the majority of the attention of wildlife enthusiasts.</p>
                        <p><strong>ROUTE :</strong> AIRPORT | NEGOMBO | PINNAWALA | SIGIRIYA | HABARANA | POLONNARUWA | DAMBULLA | KANDY | KITULGALA | NUWARA ELIYA | ELLA | YALA | GALLE | HIKKADUWA | COLOMBO | AIRPORT</p>
                    </div>
                    ...
                    <div class="ibox-content inspinia-timeline animated fadeInRight">
                        ...
                        <div class="timeline-item">
                            <div class="row">
                                ...
                                <div class="col-xs-11 content no-top-border">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="row">
                                            <img style="width: 100%;" src="<?php echo base_url('img/tour_packages/package2/day-01.jpg'); ?>" alt="day1">
                                        </div>
                        ...
                        <div class="timeline-item">
                            <div class="row">
                                ...
                                <div class="col-xs-9 content no-top-border">
                                    <p class="m-b-xs"><strong>NEGOMBO / PINNAWALA / SIGIRIYA / HABARANA</strong></p>
                                    <div class="col-xs-4">
                                        <div class="row">
                                            <img style="width: 100%;" src="<?php echo base_url('img/tour_packages/package2/day-02.jpg'); ?>" alt="day1">
                                        </div>

                                    </div>    
                                    <div class="col-xs-8">
                                        <ul>
                                            <li>Breakfast at the hotel and travel to Sigiriya.</li>
                                            ...
                                            <li>Then proceed to Sigiriya and check in to the hotel.</li>
                                            <li>Evening climb at Sigiriya Rock fortress.</li>
                        ...
                        <div class="timeline-item">
                            <div class="row">
                                ...
                                <div class="col-xs-9 content no-top-border">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="row">
                                            <img style="width: 100%;" src="<?php echo base_url('img/tour_packages/package2/day-03.jpg'); ?>" alt="day1">
                                        </div>

                                    </div>    
                                    <div class="col-xs-8">
                                        <ul>
                                            <li>Breakfast at the hotel and travel to Polonnaruwa.</li>
                                            <li>En-route you will an Elephant Ride and Village Cart Ride at Habarana.</li>
                        ...
                        <div class="timeline-item">
                            <div class="row">
                                ...
                                <div class="col-xs-9 content no-top-border">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="row">
                                            <img style="width: 100%;" src="<?php echo base_url('img/tour_packages/package2/day-04.jpg'); ?>" alt="day1">
                                        </div>
                        ...
                        <div class="timeline-item">
                            <div class="row">
                                ...
                                <div class="col-xs-9 content no-top-border">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="row">
                                            <img style="width: 100%;" src="<?php echo base_url('img/tour_packages/package2/day-05.jpg'); ?>" alt="day1">
                                        </div>
                                    ...
                                    <div class="col-xs-8">
                                        <ul>
                                            ...
                                            <li>Then visit the Kandy Lake.</li>
                                            <li>View a Kandy city and Lake at view Point.</li>
                        ...
                        <div class="timeline-item">
                            <div class="row">
                                ...
                                <div class="col-xs-9 content no-top-border">
                                    <p class="m-b-xs"><strong>NUWARA ELIYA / ELLA / YALA</strong></p>
                                    <div class="col-xs-4">
                                        <div class="row">
                                            <img style="width: 100%;" src="<?php echo base_url('img/tour_packages/package2/day-06.jpg'); ?>" alt="day1">
                                        </div>
                                    ...
                                    <div class="col-xs-8">
                                        <ul>
                                            ...
                                            <li>En-route visit the Ella Gap and Ravana Waterfall.</li>
                        ...
                        <div class="timeline-item">
                            <div class="row">
                                ...
                                <div class="col-xs-9 content no-top-border">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="row">
                                            <img style="width: 100%;" src="<?php echo base_url('img/tour_packages/package2/day-07.jpg'); ?>" alt="day1">
                                        </div>
                        ...
                        <div class="timeline-item">
                            <div class="row">
                                ...
                                <div class="col-xs-9 content no-top-border">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="row">
                                            <img style="width: 100%;" src="<?php echo base_url('img/tour_packages/package2/day-08.jpg'); ?>" alt="day1">
                                        </div>
                        ...
                        <div class="timeline-item">
                            <div class="row">
                                ...
                                <div class="col-xs-9 content no-top-border">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="row">
                                            <img style="width: 100%;" src="<?php echo base_url('img/tour_packages/package2/day-09.jpg'); ?>" alt="day1">
                                        </div>
                        ...
                        <div class="timeline-item">
                            <div class="row">
                                ...
                                <div class="col-xs-9 content no-top-border">
                                    <p class="m-b-xs"><strong>HIKKADUWA / COLOMBO / AIRPORT - DEPARTURE</strong></p>
                                    <div class="col-xs-4">
                                        <div class="row">
                                            <img style="width: 100%;" src="<?php echo base_url('img/tour_packages/package2/day-10.jpg'); ?>" alt="day1">
                                        </div>
                                    ...
                                    <div class="col-xs-8">
                                        <ul>
                                            ...
                                            <li>Then you will have a city tour in Colombo, visit the Tourist attractions in Colombo.</li>
            ...
            <div class="col-sm-4">
                ...
                <div class="blog-twitter">
                    <div class="headline"><h3>Rates (10 Days / 09 Nights)</h3></div>
