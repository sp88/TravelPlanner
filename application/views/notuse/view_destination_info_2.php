                            ...
                            <div id="collapseOne" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    <table class="table">
                                        <tr>
                                            <td>
                                                <span class="glyphicon glyphicon-pencil text-primary"></span><a href="#">About Destination</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <span class="glyphicon glyphicon-file text-info"></span><a href="#">Trip Plans</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                ...
                <div class="row" style="padding-right: 15px;">
                    ...
                    <div class="ibox-content" style="padding: 40px; padding-top: 10px;"> 
                        <div class="row" >
                            ...
                            <p class="dest_description" style="text-indent: 50px;"><!--About Destination--></p>
                        </div>
                        <div class="row">
                                    ...
                                    <li id="post-348" class="col-md-3 col-xs-6 place-item post-348 place type-place status-publish has-post-thumbnail hentry review_criteria-comfotable review_criteria-food review_criteria-location review_criteria-view place_category-family-style location-usa">
                                        <div class="place-wrapper">
                                            ...
                                            <ol class="edit-place-option">
                                                <li style="display:inline-block"><a href="#edit_place" class="action edit" data-target="#" data-action="edit"><i class="fa fa-pencil"></i></a>
                                                </li>
                                                <li style="display:inline-block"><a href="#" class="action archive" data-action="archive"><i class="fa fa-trash-o"></i></a>
                                                </li>
            ...
            success: function (data) {
                if (data != "false") {
                    $.each(data, function (key, value) {
                        ...
                        $('.desc_title').html('Description about ' + value.dest_name);
